...
typedef enum { UNDEF_LOCATION = 0, TERRACE = 1, CELLAR = 2, ROOM_1 = 3, KITCHEN = 4, STAIRS = 5, WATERTANK = 6 } ServiceLocation;

typedef enum { UNDEF_SERVICE = 0, SDP_RTC = 1, TEMPERATURE = 2, PRESSURE = 3, FAN = 4, HUMIDITY = 5, LIGHT = 6, MOVEMENT = 7, LED = 8, DEPTH = 9 } ServiceType;
